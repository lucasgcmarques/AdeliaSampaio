  ...
  EQUIPE: [
    {
      ...
      image: EdileuzaImg,
      description: [
        'Doutora em Educação pela Universidade de Brasília (UnB, 2013), mestre em Educação e Contemporaneidade pela Universidade do Estado da Bahia (UNEB, 2005), graduada em História pela Universidade Federal do Espírito Santo (UFES, 1994).',
        'Desde 2006 desenvolve pesquisas na área de cinema, com ênfase no Cinema Negro no Brasil. Trabalha com Educação atuando nos temas: Educação Escolar Quilombolas, Arte e cinema africano e diaspórico, Cinema e cineastas negras, Educação das relações étnico-raciais, formação de professores, Lei 10.639/2003.',
      ],
    },
    {
      id: 2,
      ...
      image: MarcusImg,
      description: [
        'Mestrando em Artes Visuais e bacharel em audiovisual, pela Universidade de Brasília – UnB. É professor da Secretaria de Educação do Distrito Federal, bem como atua em diferentes áreas da produção cinematográfica.',
        'Dentre outras realizações, foi técnico de som do documentário Lima (2015) e assistente de fotografia do curta A Hora da Morte (2015), roteirizou e dirigiu o curta-metragem Afronte (2017), premiado em diferentes festivais de cinema bem como o Coelho de Ouro de Melhor Curta-Metragem no Festival Mix de 2017; Prêmio Saruê e Melhor Montagem da Mostra Brasília no 50º Festival de Brasília do Cinema Brasileiro.',
        'Produtor da Mostra Competitiva de Cinema Negro - Adélia Sampaio e do documentário Filhas de Lavadeiras (2019). Foi um dos curadores do Festival Universitário de Brasília 2019, Co-dirigiu e roteirizou o longa-metragem Rumo (2021)',
      ],
    },
    {
      id: 3,
